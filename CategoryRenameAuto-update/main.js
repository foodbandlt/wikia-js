...
/* Error box */			+ '<tr><td>&#160;</td><td class="mw-submit"><a style="margin-left: 0px;" class="wikia-button" onclick="LIR.start(&quot;single&quot;)">Rename</a><span id="liveLoader" style="display:none"><img src="http://slot1.images.wikia.nocookie.net/__cb62004/common/skins/common/progress-wheel.gif" /></span><span id="queueStatus" style="font-weight: bold"></span></td></tr><tr><td class="mw-label">Failed items:</td><td class="mw-input"><div id="LIRFailedLog" style="width: 798px; margin: 5px auto 0px auto; background-color: #ffbfbf; height: 150px; border: 1px solid black; font-weight: bold; overflow: scroll;">Failed items appear here after execution. Note that pages that the category is transcluded through a template on will also appear here falsely.</div></td></tr>';
